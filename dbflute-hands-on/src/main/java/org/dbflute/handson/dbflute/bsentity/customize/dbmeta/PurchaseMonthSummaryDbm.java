...
/**
 * The DB meta of PurchaseMonthSummary. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class PurchaseMonthSummaryDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final PurchaseMonthSummaryDbm _instance = new PurchaseMonthSummaryDbm();
    private PurchaseMonthSummaryDbm() {}
    public static PurchaseMonthSummaryDbm getInstance() { return _instance; }
    ...
    public static class EpgMemberId implements PropertyGateway {
        public Object read(Entity et) { return ((PurchaseMonthSummary)et).getMemberId(); }
        public void write(Entity et, Object vl) { ((PurchaseMonthSummary)et).setMemberId(cti(vl)); }
    }
    public static class EpgMemberName implements PropertyGateway {
        public Object read(Entity et) { return ((PurchaseMonthSummary)et).getMemberName(); }
        public void write(Entity et, Object vl) { ((PurchaseMonthSummary)et).setMemberName((String)vl); }
    }
    public static class EpgPurchaseMonth implements PropertyGateway {
        public Object read(Entity et) { return ((PurchaseMonthSummary)et).getPurchaseMonth(); }
        public void write(Entity et, Object vl) { ((PurchaseMonthSummary)et).setPurchaseMonth(ctl(vl)); }
    }
    public static class EpgPurchasePriceAverageMonth implements PropertyGateway {
        public Object read(Entity et) { return ((PurchaseMonthSummary)et).getPurchasePriceAverageMonth(); }
        public void write(Entity et, Object vl) { ((PurchaseMonthSummary)et).setPurchasePriceAverageMonth(ctb(vl)); }
    }
    public static class EpgPurchaseCountSumMonth implements PropertyGateway {
        public Object read(Entity et) { return ((PurchaseMonthSummary)et).getPurchaseCountSumMonth(); }
        public void write(Entity et, Object vl) { ((PurchaseMonthSummary)et).setPurchaseCountSumMonth(ctb(vl)); }
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "PurchaseMonthSummary";
    protected final String _tablePropertyName = "purchaseMonthSummary";
    protected final TableSqlName _tableSqlName = new TableSqlName("PurchaseMonthSummary", _tableDbName);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.dbflute.handson.dbflute.exentity.customize.PurchaseMonthSummary"; }
    ...
    //                                                                         Object Type
    //                                                                         ===========
    public Class<PurchaseMonthSummary> getEntityType() { return PurchaseMonthSummary.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public PurchaseMonthSummary newEntity() { return new PurchaseMonthSummary(); }
    public PurchaseMonthSummary newMyEntity() { return new PurchaseMonthSummary(); }

    // ===================================================================================
    //                                                                   Map Communication
    //                                                                   =================
    public void acceptPrimaryKeyMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptPrimaryKeyMap((PurchaseMonthSummary)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((PurchaseMonthSummary)et, mp); }
