...
/**
 * The base class for typed parameter-bean of PurchaseMonthCursor. <br />
 * This is related to "<span style="color: #AD4747">selectPurchaseMonthCursor</span>" on PurchaseBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsPurchaseMonthCursorPmb implements CursorHandlingPmb<PurchaseBhv, Void>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of PurchaseMonthCursor. <br />
     * This is related to "<span style="color: #AD4747">selectPurchaseMonthCursor</span>" on PurchaseBhv.
     */
    public BsPurchaseMonthCursorPmb() {
    }
    ...
    public String getOutsideSqlPath() {
        return "selectPurchaseMonthCursor";
    }
