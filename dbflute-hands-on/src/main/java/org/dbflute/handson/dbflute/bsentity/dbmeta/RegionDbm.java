...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, null, Integer.class, "regionId", null, true, false, true, "INT", 10, 0, null, false, null, null, null, "memberAddressList", CDef.DefMeta.Region);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.dbflute.handson.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "org.dbflute.handson.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "org.dbflute.handson.dbflute.exbhv.RegionBhv"; }
