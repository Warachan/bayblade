...
public class WithdrawalReasonDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnWithdrawalReasonText = cci("WITHDRAWAL_REASON_TEXT", "WITHDRAWAL_REASON_TEXT", null, null, true, "withdrawalReasonText", String.class, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null);
