...
/**
 * The entity of PurchaseMonthSummary. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public abstract class BsPurchaseMonthSummary extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta getDBMeta() {
        return org.dbflute.handson.dbflute.bsentity.customize.dbmeta.PurchaseMonthSummaryDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsPurchaseMonthSummary) {
            BsPurchaseMonthSummary other = (BsPurchaseMonthSummary)obj;
    ...
    @Override
    public PurchaseMonthSummary clone() {
        return (PurchaseMonthSummary)super.clone();
    }
