...
/**
 * The base class for typed parameter-bean of PartOfPurchaseMonthSummary. <br />
 * This is related to "<span style="color: #AD4747">selectPartOfPurchaseMonthSummary</span>" on PurchaseBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsPartOfPurchaseMonthSummaryPmb extends SimplePagingBean implements EntityHandlingPmb<PurchaseBhv, PartOfPurchaseMonthSummary>, ManualPagingHandlingPmb<PurchaseBhv, PartOfPurchaseMonthSummary>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of PartOfPurchaseMonthSummary. <br />
     * This is related to "<span style="color: #AD4747">selectPartOfPurchaseMonthSummary</span>" on PurchaseBhv.
     */
    public BsPartOfPurchaseMonthSummaryPmb() {
    ...
    public String getOutsideSqlPath() {
        return "selectPartOfPurchaseMonthSummary";
    }
     ...
     */
    public Class<PartOfPurchaseMonthSummary> getEntityType() {
        return PartOfPurchaseMonthSummary.class;
    }
