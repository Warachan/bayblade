...
public class ServiceRankDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnNewAcceptableFlg = cci("NEW_ACCEPTABLE_FLG", "NEW_ACCEPTABLE_FLG", null, null, Integer.class, "newAcceptableFlg", null, false, false, true, "INT", 10, 0, null, false, null, null, null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.dbflute.handson.dbflute.exentity.ServiceRank"; }
    public String getConditionBeanTypeName() { return "org.dbflute.handson.dbflute.cbean.ServiceRankCB"; }
    public String getBehaviorTypeName() { return "org.dbflute.handson.dbflute.exbhv.ServiceRankBhv"; }
