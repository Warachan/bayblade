...
/**
 * The entity of PurchaseMonthCursor. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public abstract class BsPurchaseMonthCursor extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta getDBMeta() {
        return org.dbflute.handson.dbflute.bsentity.customize.dbmeta.PurchaseMonthCursorDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsPurchaseMonthCursor) {
            BsPurchaseMonthCursor other = (BsPurchaseMonthCursor)obj;
    ...
    @Override
    public PurchaseMonthCursor clone() {
        return (PurchaseMonthCursor)super.clone();
    }
