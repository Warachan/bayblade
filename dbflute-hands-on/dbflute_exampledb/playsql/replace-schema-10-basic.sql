...
本当は良くないが、Exampleなのでひとまず暗号化していない。',
    ...
    REMINDER_USE_COUNT INTEGER NOT NULL COMMENT '会員セキュリティ情報にリマインダ回数',
    REGISTER_DATETIME DATETIME NOT NULL,
    REGISTER_USER VARCHAR(200) NOT NULL,
    UPDATE_DATETIME DATETIME NOT NULL,
    UPDATE_USER VARCHAR(200) NOT NULL,
...
create table MEMBER_SERVICE(
    MEMBER_SERVICE_ID INTEGER AUTO_INCREMENT NOT NULL COMMENT '会員サービスに代理キー',
...
create table PRODUCT_STATUS(
    ...
    DISPLAY_ORDER INTEGER NOT NULL COMMENT '表示順カラム',
