...
public abstract class BsLoginBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends Login> ENTITY doSelectEntity(LoginCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectEntityInternally(cb, tp, new InternalSelectEntityCallback<ENTITY, LoginCB>() {
            public List<ENTITY> callbackSelectList(LoginCB lcb, Class<ENTITY> ltp) { return doSelectList(lcb, ltp); } });
    }
    ...
    protected <ENTITY extends Login> ENTITY doSelectEntityWithDeletedCheck(LoginCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", tp);
        return helpSelectEntityWithDeletedCheckInternally(cb, tp, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, LoginCB>() {
            public List<ENTITY> callbackSelectList(LoginCB lcb, Class<ENTITY> ltp) { return doSelectList(lcb, ltp); } });
    }
    ...
    public Login selectByPKValue(Integer loginId) {
        return doSelectByPK(loginId, Login.class);
    }

    protected <ENTITY extends Login> ENTITY doSelectByPK(Integer loginId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(loginId), entityType);
    }

    protected <ENTITY extends Login> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer loginId, Class<ENTITY> entityType) {
        return createOptionalEntity(doSelectByPK(loginId, entityType), loginId);
    }
    ...
    public Login selectByPKValueWithDeletedCheck(Integer loginId) {
        return doSelectByPKWithDeletedCheck(loginId, Login.class);
    }

    protected <ENTITY extends Login> ENTITY doSelectByPKWithDeletedCheck(Integer loginId, Class<ENTITY> entityType) {
        return doSelectEntityWithDeletedCheck(xprepareCBAsPK(loginId), entityType);
    }

    protected LoginCB xprepareCBAsPK(Integer loginId) {
        assertObjectNotNull("loginId", loginId);
        LoginCB cb = newMyConditionBean(); cb.acceptPrimaryKey(loginId);
        return cb;
    }
    ...
    protected <ENTITY extends Login> ListResultBean<ENTITY> doSelectList(LoginCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, LoginCB>() {
            public List<ENTITY> callbackSelectList(LoginCB lcb, Class<ENTITY> ltp) { return delegateSelectList(lcb, ltp); } });
    }
    ...
    protected <ENTITY extends Login> PagingResultBean<ENTITY> doSelectPage(LoginCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", tp);
        return helpSelectPageInternally(cb, tp, new InternalSelectPageCallback<ENTITY, LoginCB>() {
            public int callbackSelectCount(LoginCB cb) { return doSelectCountPlainly(cb); }
            public List<ENTITY> callbackSelectList(LoginCB cb, Class<ENTITY> tp) { return doSelectList(cb, tp); }
        });
    }
    ...
    protected <ENTITY extends Login> void doSelectCursor(LoginCB cb, EntityRowHandler<ENTITY> handler, Class<ENTITY> tp) {
        ...
        assertSpecifyDerivedReferrerEntityProperty(cb, tp);
        helpSelectCursorInternally(cb, handler, tp, new InternalSelectCursorCallback<ENTITY, LoginCB>() {
            public void callbackSelectCursor(LoginCB cb, EntityRowHandler<ENTITY> handler, Class<ENTITY> tp) { delegateSelectCursor(cb, handler, tp); }
            public List<ENTITY> callbackSelectList(LoginCB cb, Class<ENTITY> tp) { return doSelectList(cb, tp); }
        });
    }
    ...
    protected <RESULT, CB extends LoginCB> SLFunction<CB, RESULT> doScalarSelect(Class<RESULT> tp, CB cb) {
        assertObjectNotNull("resultType", tp); assertCBStateValid(cb);
        cb.xsetupForScalarSelect(); cb.getSqlClause().disableSelectIndex(); // for when you use union
        return createSLFunction(cb, tp);
    }

    protected <RESULT, CB extends LoginCB> SLFunction<CB, RESULT> createSLFunction(CB cb, Class<RESULT> tp) {
    ...
    public List<Member> pulloutMember(List<Login> loginList) {
        return helpPulloutInternally(loginList, new InternalPulloutCallback<Login, Member>() {
            public Member getFr(Login et)
            { return et.getMember(); }
            public boolean hasRf() { return true; }
            public void setRfLs(Member et, List<Login> ls)
            { et.setLoginList(ls); }
        });
    }
    ...
    public List<Integer> extractLoginIdList(List<Login> loginList) {
        return helpExtractListInternally(loginList, new InternalExtractCallback<Login, Integer>() {
            public Integer getCV(Login et) { return et.getLoginId(); }
        });
    }
     ...
     * @param login The entity of insert target. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
    ...
    protected void doInsert(Login login, InsertOption<LoginCB> op) {
        assertObjectNotNull("login", login);
        prepareInsertOption(op);
        delegateInsert(login, op);
    }
     ...
     * }
     * </pre>
     * @param login The entity of update target. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnRequired)
     * @exception EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception EntityDuplicatedException When the entity has been duplicated.
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    ...
    protected void doUpdate(Login login, final UpdateOption<LoginCB> op) {
        assertObjectNotNull("login", login);
        prepareUpdateOption(op);
        helpUpdateInternally(login, new InternalUpdateCallback<Login>() {
            public int callbackDelegateUpdate(Login et) { return delegateUpdate(et, op); } });
    }
    ...
    protected void doInesrtOrUpdate(Login login, final InsertOption<LoginCB> iop, final UpdateOption<LoginCB> uop) {
        helpInsertOrUpdateInternally(login, new InternalInsertOrUpdateCallback<Login, LoginCB>() {
            public void callbackInsert(Login et) { doInsert(et, iop); }
            public void callbackUpdate(Login et) { doUpdate(et, uop); }
    ...
    protected void doCreateOrModify(Entity et, InsertOption<? extends ConditionBean> iop, UpdateOption<? extends ConditionBean> uop) {
        if (iop == null && uop == null) { insertOrUpdate(downcast(et)); }
            ...
            iop = iop != null ? iop : new InsertOption<LoginCB>();
            uop = uop != null ? uop : new UpdateOption<LoginCB>();
     ...
     * }
     * </pre>
     * @param login The entity of delete target. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnRequired)
     * @exception EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    ...
    protected void doDelete(Login login, final DeleteOption<LoginCB> op) {
        assertObjectNotNull("login", login);
        prepareDeleteOption(op);
        helpDeleteInternally(login, new InternalDeleteCallback<Login>() {
            public int callbackDelegateDelete(Login et) { return delegateDelete(et, op); } });
    }

    protected void prepareDeleteOption(DeleteOption<LoginCB> op) {
        if (op == null) { return; }
    ...
    public int[] batchInsert(List<Login> loginList) {
        InsertOption<LoginCB> op = createInsertUpdateOption();
        return doBatchInsert(loginList, op);
    }

    protected int[] doBatchInsert(List<Login> loginList, InsertOption<LoginCB> op) {
        assertObjectNotNull("loginList", loginList);
        prepareBatchInsertOption(loginList, op);
        return delegateBatchInsert(loginList, op);
    }

    protected void prepareBatchInsertOption(List<Login> loginList, InsertOption<LoginCB> op) {
        op.xallowInsertColumnModifiedPropertiesFragmented();
        op.xacceptInsertColumnModifiedPropertiesIfNeeds(loginList);
        prepareInsertOption(op);
    }
    ...
    public int[] batchUpdate(List<Login> loginList) {
        UpdateOption<LoginCB> op = createPlainUpdateOption();
        return doBatchUpdate(loginList, op);
    }

    protected int[] doBatchUpdate(List<Login> loginList, UpdateOption<LoginCB> op) {
        assertObjectNotNull("loginList", loginList);
        prepareBatchUpdateOption(loginList, op);
        return delegateBatchUpdate(loginList, op);
    }

    protected void prepareBatchUpdateOption(List<Login> loginList, UpdateOption<LoginCB> op) {
        op.xacceptUpdateColumnModifiedPropertiesIfNeeds(loginList);
        prepareUpdateOption(op);
    }
    ...
    protected int[] doBatchDelete(List<Login> loginList, DeleteOption<LoginCB> op) {
        assertObjectNotNull("loginList", loginList);
        prepareDeleteOption(op);
        return delegateBatchDelete(loginList, op);
    }
    ...
    protected int doQueryInsert(QueryInsertSetupper<Login, LoginCB> sp, InsertOption<LoginCB> op) {
        ...
        prepareInsertOption(op);
        Login e = new Login();
        LoginCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(Login login, LoginCB cb, UpdateOption<LoginCB> op) {
        assertObjectNotNull("login", login); assertCBStateValid(cb);
        prepareUpdateOption(op);
        return checkCountBeforeQueryUpdateIfNeeds(cb) ? delegateQueryUpdate(login, cb, op) : 0;
    }

    @Override
    protected int doRangeModify(Entity et, ConditionBean cb, UpdateOption<? extends ConditionBean> op) {
        if (op == null) { return queryUpdate(downcast(et), (LoginCB)cb); }
        else { return varyingQueryUpdate(downcast(et), (LoginCB)cb, downcast(op)); }
    }
    ...
    protected int doRangeRemove(ConditionBean cb, DeleteOption<? extends ConditionBean> op) {
        if (op == null) { return queryDelete((LoginCB)cb); }
        else { return varyingQueryDelete((LoginCB)cb, downcast(op)); }
    }
    ...
    protected <ENTITY extends Login> void delegateSelectCursor(LoginCB cb, EntityRowHandler<ENTITY> rh, Class<ENTITY> tp)
    { invoke(createSelectCursorCBCommand(cb, rh, tp)); }
    protected <ENTITY extends Login> List<ENTITY> delegateSelectList(LoginCB cb, Class<ENTITY> tp)
    { return invoke(createSelectListCBCommand(cb, tp)); }

    // -----------------------------------------------------
    //                                                Update
    //                                                ------
    protected int delegateInsert(Login et, InsertOption<LoginCB> op)
    { if (!processBeforeInsert(et, op)) { return 0; }
      return invoke(createInsertEntityCommand(et, op)); }
    protected int delegateUpdate(Login et, UpdateOption<LoginCB> op)
    { if (!processBeforeUpdate(et, op)) { return 0; }
      return delegateUpdateNonstrict(et, op); }
    protected int delegateUpdateNonstrict(Login et, UpdateOption<LoginCB> op)
    { if (!processBeforeUpdate(et, op)) { return 0; }
      return invoke(createUpdateNonstrictEntityCommand(et, op)); }
    protected int delegateDelete(Login et, DeleteOption<LoginCB> op)
    { if (!processBeforeDelete(et, op)) { return 0; }
      return delegateDeleteNonstrict(et, op); }
    protected int delegateDeleteNonstrict(Login et, DeleteOption<LoginCB> op)
    { if (!processBeforeDelete(et, op)) { return 0; }
    ...
    protected int delegateQueryInsert(Login et, LoginCB inCB, ConditionBean resCB, InsertOption<LoginCB> op)
    { if (!processBeforeQueryInsert(et, inCB, resCB, op)) { return 0; } return invoke(createQueryInsertCBCommand(et, inCB, resCB, op));  }
    protected int delegateQueryUpdate(Login et, LoginCB cb, UpdateOption<LoginCB> op)
    ...
    //                                                                     Downcast Helper
    //                                                                     ===============
    protected Login downcast(Entity et) {
        return helpEntityDowncastInternally(et, Login.class);
    }
    ...
    protected List<Login> downcast(List<? extends Entity> ls) {
        return (List<Login>)ls;
    }

    @SuppressWarnings("unchecked")
    protected InsertOption<LoginCB> downcast(InsertOption<? extends ConditionBean> op) {
        return (InsertOption<LoginCB>)op;
    }

    @SuppressWarnings("unchecked")
    protected UpdateOption<LoginCB> downcast(UpdateOption<? extends ConditionBean> op) {
        return (UpdateOption<LoginCB>)op;
    }

    @SuppressWarnings("unchecked")
    protected DeleteOption<LoginCB> downcast(DeleteOption<? extends ConditionBean> op) {
        return (DeleteOption<LoginCB>)op;
    }
