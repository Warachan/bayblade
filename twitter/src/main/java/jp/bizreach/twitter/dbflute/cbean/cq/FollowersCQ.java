...
import jp.bizreach.twitter.dbflute.cbean.cq.bs.BsFollowersCQ;

/**
 * The condition-query of followers.
 * <p>
 ...
 */
public class FollowersCQ extends BsFollowersCQ {
     ...
     */
    public FollowersCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
