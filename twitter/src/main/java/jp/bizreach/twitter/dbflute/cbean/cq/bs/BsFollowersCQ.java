...
public class BsFollowersCQ extends AbstractBsFollowersCQ {
     ...
     * @return this. (NotNull)
     */
    public BsFollowersCQ addSpecifiedDerivedOrderBy_Asc(String aliasName) { registerSpecifiedDerivedOrderBy_Asc(aliasName); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsFollowersCQ addSpecifiedDerivedOrderBy_Desc(String aliasName) { registerSpecifiedDerivedOrderBy_Desc(aliasName); return this; }
    ...
    protected MemberCQ xcreateQueryMember() {
        String nrp = xresolveNRP("followers", "member"); String jan = xresolveJAN(nrp, xgetNNLvl());
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, FollowersCQ> getScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(FollowersCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, FollowersCQ> getSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(FollowersCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, FollowersCQ> getQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    public String keepQueryMyselfDerived(FollowersCQ sq) { return xkeepSQue("queryMyselfDerived", sq); }
    ...
    public Map<String, FollowersCQ> getMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(FollowersCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, FollowersCQ> getMyselfInScope() { return xgetSQueMap("myselfInScope"); }
    public String keepMyselfInScope(FollowersCQ sq) { return xkeepSQue("myselfInScope", sq); }
