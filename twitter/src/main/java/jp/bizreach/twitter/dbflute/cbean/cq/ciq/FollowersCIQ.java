...
/**
 * The condition-query for in-line of followers.
 * @author DBFlute(AutoGenerator)
 */
public class FollowersCIQ extends AbstractBsFollowersCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsFollowersCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public FollowersCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsFollowersCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue getCValueFollowersid() { return _myCQ.getFollowersid(); }
    ...
    protected String xinCB() { return FollowersCB.class.getName(); }
    protected String xinCQ() { return FollowersCQ.class.getName(); }
}
