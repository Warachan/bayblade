...
public class BsLoginCB extends AbstractConditionBean {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_LoginId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_LoginId_Desc();
        return this;
    }
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;LoginCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;LoginCB&gt;() {
     *     public void query(LoginCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = login.<span style="color: #DD4747">getMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<LoginCQ> {
        ...
        public HpSDRFunction<LoginCB, LoginCQ> myselfDerived() {
            ...
            return new HpSDRFunction<LoginCB, LoginCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<LoginCB, LoginCQ>() {
                public void setup(String fn, SubQuery<LoginCB> sq, LoginCQ cq, String al, DerivedReferrerOption op) {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;LoginCB&gt;() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;LoginCB&gt;() {
     ...
     *     public void query(LoginCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;LoginCB&gt;() {
