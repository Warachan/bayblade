...
import jp.bizreach.twitter.dbflute.cbean.cq.bs.BsBlackCompanyCQ;

/**
 * The condition-query of black_company.
 * <p>
 ...
 */
public class BlackCompanyCQ extends BsBlackCompanyCQ {
     ...
     */
    public BlackCompanyCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
