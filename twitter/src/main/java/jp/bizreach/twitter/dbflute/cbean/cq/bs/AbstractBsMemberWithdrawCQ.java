...
/**
 * The abstract condition-query of member_withdraw.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsMemberWithdrawCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsMemberWithdrawCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;MemberWithdrawCB&gt;() {
     ...
     */
    public HpSSQFunction<MemberWithdrawCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ.getOperand(), MemberWithdrawCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;MemberWithdrawCB&gt;() {
     *     public void query(MemberWithdrawCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MemberWithdrawCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES.getOperand(), MemberWithdrawCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;MemberWithdrawCB&gt;() {
     *     public void query(MemberWithdrawCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MemberWithdrawCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT.getOperand(), MemberWithdrawCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;MemberWithdrawCB&gt;() {
     *     public void query(MemberWithdrawCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MemberWithdrawCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT.getOperand(), MemberWithdrawCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;MemberWithdrawCB&gt;() {
     *     public void query(MemberWithdrawCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MemberWithdrawCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE.getOperand(), MemberWithdrawCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MemberWithdrawCB&gt;() {
     *     public void query(MemberWithdrawCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MemberWithdrawCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand(), MemberWithdrawCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSSQOption<CB> op) {
        assertObjectNotNull("subQuery", sq);
        MemberWithdrawCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        op.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, op);
    }
    public abstract String keepScalarCondition(MemberWithdrawCQ sq);

    protected MemberWithdrawCB xcreateScalarConditionCB() {
        MemberWithdrawCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected MemberWithdrawCB xcreateScalarConditionPartitionByCB() {
        MemberWithdrawCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<MemberWithdrawCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MemberWithdrawCB cb = new MemberWithdrawCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String pp = keepSpecifyMyselfDerived(cb.query());
        String pk = "MEMBER_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(MemberWithdrawCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<MemberWithdrawCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(MemberWithdrawCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MemberWithdrawCB cb = new MemberWithdrawCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MEMBER_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(MemberWithdrawCQ sq);
     ...
     */
    public void myselfExists(SubQuery<MemberWithdrawCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        MemberWithdrawCB cb = new MemberWithdrawCB(); cb.xsetupForMyselfExists(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(MemberWithdrawCQ sq);
     ...
     * @param subQuery The implementation of sub-query. (NotNull)
     */
    public void myselfInScope(SubQuery<MemberWithdrawCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        MemberWithdrawCB cb = new MemberWithdrawCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMyselfInScope(cb.query());
        registerMyselfInScope(cb.query(), pp);
    }
    public abstract String keepMyselfInScope(MemberWithdrawCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected MemberWithdrawCB newMyCB() {
        return new MemberWithdrawCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabCQ() { return MemberWithdrawCQ.class.getName(); }
