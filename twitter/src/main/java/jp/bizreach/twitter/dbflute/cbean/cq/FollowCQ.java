...
import jp.bizreach.twitter.dbflute.cbean.cq.bs.BsFollowCQ;

/**
 * The condition-query of follow.
 * <p>
 ...
 */
public class FollowCQ extends BsFollowCQ {
     ...
     */
    public FollowCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
