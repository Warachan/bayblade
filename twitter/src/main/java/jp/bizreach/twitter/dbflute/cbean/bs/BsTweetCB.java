 ...
 */
public class BsTweetCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TweetCQ _conditionQuery;
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_TweetId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_TweetId_Desc();
        return this;
    }
     ...
     */
    public TweetCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return getConditionQuery();
    }

    public TweetCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected TweetCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TweetCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TweetCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TweetCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TweetCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;TweetCB&gt;() {
     ...
     */
    public void union(UnionQuery<TweetCB> unionQuery) {
        final TweetCB cb = new TweetCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TweetCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;TweetCB&gt;() {
     *     public void query(TweetCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<TweetCB> unionQuery) {
        final TweetCB cb = new TweetCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TweetCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<TweetCQ>() {
                public boolean has() { return true; }
                public TweetCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<TweetCQ> {
        protected MemberCB.HpSpecification _member;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TweetCQ> qyCall
         ...
         */
        public HpSDRFunction<TweetCB, TweetCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return new HpSDRFunction<TweetCB, TweetCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<TweetCB, TweetCQ>() {
                public void setup(String fn, SubQuery<TweetCB> sq, TweetCQ cq, String al, DerivedReferrerOption op) {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;TweetCB&gt;() {
     *     public void query(TweetCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;TweetCB&gt;() {
     *     public void query(TweetCB cb) {
     ...
     */
    public HpColQyOperand<TweetCB> columnQuery(final SpecifyQuery<TweetCB> leftSpecifyQuery) {
        return new HpColQyOperand<TweetCB>(new HpColQyHandler<TweetCB>() {
            public HpCalculator handle(SpecifyQuery<TweetCB> rightSp, String operand) {
                return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), leftSpecifyQuery, rightSp, operand);
            }
        });
    }

    protected TweetCB xcreateColumnQueryCB() {
        TweetCB cb = new TweetCB();
        cb.xsetupForColumnQuery((TweetCB)this);
        return cb;
    }
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;TweetCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<TweetCB> orQuery) {
        xorSQ((TweetCB)this, orQuery);
    }
     ...
     *     public void query(TweetCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;TweetCB&gt;() {
     *             public void query(TweetCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TweetCB> andQuery) {
        xorSQAP((TweetCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        ...
        specify().xsetSyncQyCall(new HpSpQyCall<TweetCQ>() {
            public boolean has() { return true; }
            public TweetCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return TweetCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return TweetCQ.class.getName(); }
