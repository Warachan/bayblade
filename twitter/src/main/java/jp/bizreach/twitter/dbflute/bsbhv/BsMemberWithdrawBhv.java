...
public abstract class BsMemberWithdrawBhv extends AbstractBehaviorWritable {
    ...
    public MemberWithdraw selectEntity(MemberWithdrawCB cb) {
        return doSelectEntity(cb, MemberWithdraw.class);
    }

    protected <ENTITY extends MemberWithdraw> ENTITY doSelectEntity(MemberWithdrawCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", tp);
        return helpSelectEntityInternally(cb, tp, new InternalSelectEntityCallback<ENTITY, MemberWithdrawCB>() {
            public List<ENTITY> callbackSelectList(MemberWithdrawCB lcb, Class<ENTITY> ltp) { return doSelectList(lcb, ltp); } });
    }
    ...
    public MemberWithdraw selectEntityWithDeletedCheck(MemberWithdrawCB cb) {
        return doSelectEntityWithDeletedCheck(cb, MemberWithdraw.class);
    }

    protected <ENTITY extends MemberWithdraw> ENTITY doSelectEntityWithDeletedCheck(MemberWithdrawCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", tp);
        return helpSelectEntityWithDeletedCheckInternally(cb, tp, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, MemberWithdrawCB>() {
            public List<ENTITY> callbackSelectList(MemberWithdrawCB lcb, Class<ENTITY> ltp) { return doSelectList(lcb, ltp); } });
    }
    ...
    public MemberWithdraw selectByPKValue(Integer memberId) {
        return doSelectByPK(memberId, MemberWithdraw.class);
    }

    protected <ENTITY extends MemberWithdraw> ENTITY doSelectByPK(Integer memberId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(memberId), entityType);
    }

    protected <ENTITY extends MemberWithdraw> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer memberId, Class<ENTITY> entityType) {
    ...
    public MemberWithdraw selectByPKValueWithDeletedCheck(Integer memberId) {
        return doSelectByPKWithDeletedCheck(memberId, MemberWithdraw.class);
    }

    protected <ENTITY extends MemberWithdraw> ENTITY doSelectByPKWithDeletedCheck(Integer memberId, Class<ENTITY> entityType) {
    ...
    protected MemberWithdrawCB xprepareCBAsPK(Integer memberId) {
        ...
        MemberWithdrawCB cb = newMyConditionBean(); cb.acceptPrimaryKey(memberId);
        return cb;
    }
    ...
    public ListResultBean<MemberWithdraw> selectList(MemberWithdrawCB cb) {
        return doSelectList(cb, MemberWithdraw.class);
    }

    protected <ENTITY extends MemberWithdraw> ListResultBean<ENTITY> doSelectList(MemberWithdrawCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", tp);
        assertSpecifyDerivedReferrerEntityProperty(cb, tp);
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, MemberWithdrawCB>() {
            public List<ENTITY> callbackSelectList(MemberWithdrawCB lcb, Class<ENTITY> ltp) { return delegateSelectList(lcb, ltp); } });
    }
    ...
    public PagingResultBean<MemberWithdraw> selectPage(MemberWithdrawCB cb) {
        return doSelectPage(cb, MemberWithdraw.class);
    }

    protected <ENTITY extends MemberWithdraw> PagingResultBean<ENTITY> doSelectPage(MemberWithdrawCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", tp);
        return helpSelectPageInternally(cb, tp, new InternalSelectPageCallback<ENTITY, MemberWithdrawCB>() {
            public int callbackSelectCount(MemberWithdrawCB cb) { return doSelectCountPlainly(cb); }
            public List<ENTITY> callbackSelectList(MemberWithdrawCB cb, Class<ENTITY> tp) { return doSelectList(cb, tp); }
        });
    }
    ...
    public void selectCursor(MemberWithdrawCB cb, EntityRowHandler<MemberWithdraw> entityRowHandler) {
        doSelectCursor(cb, entityRowHandler, MemberWithdraw.class);
    }
    ...
    protected <ENTITY extends MemberWithdraw> void doSelectCursor(MemberWithdrawCB cb, EntityRowHandler<ENTITY> handler, Class<ENTITY> tp) {
        ...
        assertSpecifyDerivedReferrerEntityProperty(cb, tp);
        helpSelectCursorInternally(cb, handler, tp, new InternalSelectCursorCallback<ENTITY, MemberWithdrawCB>() {
            public void callbackSelectCursor(MemberWithdrawCB cb, EntityRowHandler<ENTITY> handler, Class<ENTITY> tp) { delegateSelectCursor(cb, handler, tp); }
            public List<ENTITY> callbackSelectList(MemberWithdrawCB cb, Class<ENTITY> tp) { return doSelectList(cb, tp); }
        });
    }
     ...
     */
    public <RESULT> SLFunction<MemberWithdrawCB, RESULT> scalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newMyConditionBean());
    }

    protected <RESULT, CB extends MemberWithdrawCB> SLFunction<CB, RESULT> doScalarSelect(Class<RESULT> tp, CB cb) {
        assertObjectNotNull("resultType", tp); assertCBStateValid(cb);
        cb.xsetupForScalarSelect(); cb.getSqlClause().disableSelectIndex(); // for when you use union
        return createSLFunction(cb, tp);
    }

    protected <RESULT, CB extends MemberWithdrawCB> SLFunction<CB, RESULT> createSLFunction(CB cb, Class<RESULT> tp) {
    ...
    public List<Member> pulloutMember(List<MemberWithdraw> memberWithdrawList) {
        return helpPulloutInternally(memberWithdrawList, new InternalPulloutCallback<MemberWithdraw, Member>() {
            public Member getFr(MemberWithdraw et)
            { return et.getMember(); }
            public boolean hasRf() { return true; }
            public void setRfLs(Member et, List<MemberWithdraw> ls)
            { if (!ls.isEmpty()) { et.setMemberWithdrawAsOne(ls.get(0)); } }
        });
    }
    ...
    public List<Integer> extractMemberIdList(List<MemberWithdraw> memberWithdrawList) {
        return helpExtractListInternally(memberWithdrawList, new InternalExtractCallback<MemberWithdraw, Integer>() {
            public Integer getCV(MemberWithdraw et) { return et.getMemberId(); }
        });
    }
     ...
     * @param memberWithdraw The entity of insert target. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
    ...
    protected void doInsert(MemberWithdraw memberWithdraw, InsertOption<MemberWithdrawCB> op) {
        assertObjectNotNull("memberWithdraw", memberWithdraw);
        prepareInsertOption(op);
        delegateInsert(memberWithdraw, op);
    }
     ...
     * }
     * </pre>
     * @param memberWithdraw The entity of update target. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnRequired)
     * @exception EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception EntityDuplicatedException When the entity has been duplicated.
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(final MemberWithdraw memberWithdraw) {
        doUpdate(memberWithdraw, null);
    }

    protected void doUpdate(MemberWithdraw memberWithdraw, final UpdateOption<MemberWithdrawCB> op) {
        assertObjectNotNull("memberWithdraw", memberWithdraw);
        prepareUpdateOption(op);
        helpUpdateInternally(memberWithdraw, new InternalUpdateCallback<MemberWithdraw>() {
            public int callbackDelegateUpdate(MemberWithdraw et) { return delegateUpdate(et, op); } });
    }
    ...
    protected MemberWithdrawCB createCBForVaryingUpdate() {
        MemberWithdrawCB cb = newMyConditionBean();
     ...
     * @param memberWithdraw The entity of insert or update target. (NotNull)
     * @exception EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception EntityDuplicatedException When the entity has been duplicated.
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(MemberWithdraw memberWithdraw) {
        doInesrtOrUpdate(memberWithdraw, null, null);
    }

    protected void doInesrtOrUpdate(MemberWithdraw memberWithdraw, final InsertOption<MemberWithdrawCB> iop, final UpdateOption<MemberWithdrawCB> uop) {
        helpInsertOrUpdateInternally(memberWithdraw, new InternalInsertOrUpdateCallback<MemberWithdraw, MemberWithdrawCB>() {
            public void callbackInsert(MemberWithdraw et) { doInsert(et, iop); }
            public void callbackUpdate(MemberWithdraw et) { doUpdate(et, uop); }
            public MemberWithdrawCB callbackNewMyConditionBean() { return newMyConditionBean(); }
            public int callbackSelectCount(MemberWithdrawCB cb) { return selectCount(cb); }
        });
    }
    ...
    protected void doCreateOrModify(Entity et, InsertOption<? extends ConditionBean> iop, UpdateOption<? extends ConditionBean> uop) {
        if (iop == null && uop == null) { insertOrUpdate(downcast(et)); }
            ...
            iop = iop != null ? iop : new InsertOption<MemberWithdrawCB>();
            uop = uop != null ? uop : new UpdateOption<MemberWithdrawCB>();
     ...
     * }
     * </pre>
     * @param memberWithdraw The entity of delete target. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnRequired)
     * @exception EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    ...
    protected void doDelete(MemberWithdraw memberWithdraw, final DeleteOption<MemberWithdrawCB> op) {
        assertObjectNotNull("memberWithdraw", memberWithdraw);
        prepareDeleteOption(op);
        helpDeleteInternally(memberWithdraw, new InternalDeleteCallback<MemberWithdraw>() {
            public int callbackDelegateDelete(MemberWithdraw et) { return delegateDelete(et, op); } });
    }

    protected void prepareDeleteOption(DeleteOption<MemberWithdrawCB> op) {
        if (op == null) { return; }
    ...
    public int[] batchInsert(List<MemberWithdraw> memberWithdrawList) {
        InsertOption<MemberWithdrawCB> op = createInsertUpdateOption();
        return doBatchInsert(memberWithdrawList, op);
    }

    protected int[] doBatchInsert(List<MemberWithdraw> memberWithdrawList, InsertOption<MemberWithdrawCB> op) {
        assertObjectNotNull("memberWithdrawList", memberWithdrawList);
        prepareBatchInsertOption(memberWithdrawList, op);
        return delegateBatchInsert(memberWithdrawList, op);
    }

    protected void prepareBatchInsertOption(List<MemberWithdraw> memberWithdrawList, InsertOption<MemberWithdrawCB> op) {
        op.xallowInsertColumnModifiedPropertiesFragmented();
        op.xacceptInsertColumnModifiedPropertiesIfNeeds(memberWithdrawList);
        prepareInsertOption(op);
    }
    ...
    public int[] batchUpdate(List<MemberWithdraw> memberWithdrawList) {
        UpdateOption<MemberWithdrawCB> op = createPlainUpdateOption();
        return doBatchUpdate(memberWithdrawList, op);
    }

    protected int[] doBatchUpdate(List<MemberWithdraw> memberWithdrawList, UpdateOption<MemberWithdrawCB> op) {
        assertObjectNotNull("memberWithdrawList", memberWithdrawList);
        prepareBatchUpdateOption(memberWithdrawList, op);
        return delegateBatchUpdate(memberWithdrawList, op);
    }

    protected void prepareBatchUpdateOption(List<MemberWithdraw> memberWithdrawList, UpdateOption<MemberWithdrawCB> op) {
        op.xacceptUpdateColumnModifiedPropertiesIfNeeds(memberWithdrawList);
        prepareUpdateOption(op);
    }
    ...
    protected int[] doBatchDelete(List<MemberWithdraw> memberWithdrawList, DeleteOption<MemberWithdrawCB> op) {
        assertObjectNotNull("memberWithdrawList", memberWithdrawList);
        prepareDeleteOption(op);
        return delegateBatchDelete(memberWithdrawList, op);
    }
    ...
    protected int doQueryInsert(QueryInsertSetupper<MemberWithdraw, MemberWithdrawCB> sp, InsertOption<MemberWithdrawCB> op) {
        ...
        prepareInsertOption(op);
        MemberWithdraw e = new MemberWithdraw();
        MemberWithdrawCB cb = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(MemberWithdraw memberWithdraw, MemberWithdrawCB cb, UpdateOption<MemberWithdrawCB> op) {
        assertObjectNotNull("memberWithdraw", memberWithdraw); assertCBStateValid(cb);
        prepareUpdateOption(op);
        return checkCountBeforeQueryUpdateIfNeeds(cb) ? delegateQueryUpdate(memberWithdraw, cb, op) : 0;
    }

    @Override
    protected int doRangeModify(Entity et, ConditionBean cb, UpdateOption<? extends ConditionBean> op) {
        if (op == null) { return queryUpdate(downcast(et), (MemberWithdrawCB)cb); }
        else { return varyingQueryUpdate(downcast(et), (MemberWithdrawCB)cb, downcast(op)); }
    }
    ...
    protected int doRangeRemove(ConditionBean cb, DeleteOption<? extends ConditionBean> op) {
        if (op == null) { return queryDelete((MemberWithdrawCB)cb); }
        else { return varyingQueryDelete((MemberWithdrawCB)cb, downcast(op)); }
    }
    ...
    public void varyingInsertOrUpdate(MemberWithdraw memberWithdraw, InsertOption<MemberWithdrawCB> insertOption, UpdateOption<MemberWithdrawCB> updateOption) {
        ...
        doInesrtOrUpdate(memberWithdraw, insertOption, updateOption);
    }
    ...
    //                                                Select
    //                                                ------
    protected int delegateSelectCountUniquely(MemberWithdrawCB cb) { return invoke(createSelectCountCBCommand(cb, true)); }
    protected int delegateSelectCountPlainly(MemberWithdrawCB cb) { return invoke(createSelectCountCBCommand(cb, false)); }
    protected <ENTITY extends MemberWithdraw> void delegateSelectCursor(MemberWithdrawCB cb, EntityRowHandler<ENTITY> rh, Class<ENTITY> tp)
    { invoke(createSelectCursorCBCommand(cb, rh, tp)); }
    protected <ENTITY extends MemberWithdraw> List<ENTITY> delegateSelectList(MemberWithdrawCB cb, Class<ENTITY> tp)
    { return invoke(createSelectListCBCommand(cb, tp)); }

    // -----------------------------------------------------
    //                                                Update
    //                                                ------
    protected int delegateInsert(MemberWithdraw et, InsertOption<MemberWithdrawCB> op)
    { if (!processBeforeInsert(et, op)) { return 0; }
      return invoke(createInsertEntityCommand(et, op)); }
    protected int delegateUpdate(MemberWithdraw et, UpdateOption<MemberWithdrawCB> op)
    { if (!processBeforeUpdate(et, op)) { return 0; }
      return delegateUpdateNonstrict(et, op); }
    protected int delegateUpdateNonstrict(MemberWithdraw et, UpdateOption<MemberWithdrawCB> op)
    { if (!processBeforeUpdate(et, op)) { return 0; }
      return invoke(createUpdateNonstrictEntityCommand(et, op)); }
    protected int delegateDelete(MemberWithdraw et, DeleteOption<MemberWithdrawCB> op)
    { if (!processBeforeDelete(et, op)) { return 0; }
      return delegateDeleteNonstrict(et, op); }
    protected int delegateDeleteNonstrict(MemberWithdraw et, DeleteOption<MemberWithdrawCB> op)
    { if (!processBeforeDelete(et, op)) { return 0; }
      return invoke(createDeleteNonstrictEntityCommand(et, op)); }

    protected int[] delegateBatchInsert(List<MemberWithdraw> ls, InsertOption<MemberWithdrawCB> op)
    { if (ls.isEmpty()) { return new int[]{}; }
      return invoke(createBatchInsertCommand(processBatchInternally(ls, op), op)); }
    protected int[] delegateBatchUpdate(List<MemberWithdraw> ls, UpdateOption<MemberWithdrawCB> op)
    { if (ls.isEmpty()) { return new int[]{}; }
      return delegateBatchUpdateNonstrict(ls, op); }
    protected int[] delegateBatchUpdateNonstrict(List<MemberWithdraw> ls, UpdateOption<MemberWithdrawCB> op)
    { if (ls.isEmpty()) { return new int[]{}; }
      return invoke(createBatchUpdateNonstrictCommand(processBatchInternally(ls, op, true), op)); }
    protected int[] delegateBatchDelete(List<MemberWithdraw> ls, DeleteOption<MemberWithdrawCB> op)
    { if (ls.isEmpty()) { return new int[]{}; }
      return delegateBatchDeleteNonstrict(ls, op); }
    protected int[] delegateBatchDeleteNonstrict(List<MemberWithdraw> ls, DeleteOption<MemberWithdrawCB> op)
    { if (ls.isEmpty()) { return new int[]{}; }
      return invoke(createBatchDeleteNonstrictCommand(processBatchInternally(ls, op, true), op)); }

    protected int delegateQueryInsert(MemberWithdraw et, MemberWithdrawCB inCB, ConditionBean resCB, InsertOption<MemberWithdrawCB> op)
    { if (!processBeforeQueryInsert(et, inCB, resCB, op)) { return 0; } return invoke(createQueryInsertCBCommand(et, inCB, resCB, op));  }
    protected int delegateQueryUpdate(MemberWithdraw et, MemberWithdrawCB cb, UpdateOption<MemberWithdrawCB> op)
    { if (!processBeforeQueryUpdate(et, cb, op)) { return 0; } return invoke(createQueryUpdateCBCommand(et, cb, op));  }
    protected int delegateQueryDelete(MemberWithdrawCB cb, DeleteOption<MemberWithdrawCB> op)
    ...
    //                                                                     Downcast Helper
    //                                                                     ===============
    protected MemberWithdraw downcast(Entity et) {
        return helpEntityDowncastInternally(et, MemberWithdraw.class);
    }

    protected MemberWithdrawCB downcast(ConditionBean cb) {
        return helpConditionBeanDowncastInternally(cb, MemberWithdrawCB.class);
    }

    @SuppressWarnings("unchecked")
    protected List<MemberWithdraw> downcast(List<? extends Entity> ls) {
        return (List<MemberWithdraw>)ls;
    }

    @SuppressWarnings("unchecked")
    protected InsertOption<MemberWithdrawCB> downcast(InsertOption<? extends ConditionBean> op) {
        return (InsertOption<MemberWithdrawCB>)op;
    }

    @SuppressWarnings("unchecked")
    protected UpdateOption<MemberWithdrawCB> downcast(UpdateOption<? extends ConditionBean> op) {
        return (UpdateOption<MemberWithdrawCB>)op;
    }

    @SuppressWarnings("unchecked")
    protected DeleteOption<MemberWithdrawCB> downcast(DeleteOption<? extends ConditionBean> op) {
        return (DeleteOption<MemberWithdrawCB>)op;
    }
