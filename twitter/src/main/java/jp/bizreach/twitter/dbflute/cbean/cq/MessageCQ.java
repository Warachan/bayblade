...
import jp.bizreach.twitter.dbflute.cbean.cq.bs.BsMessageCQ;
 ...
 */
public class MessageCQ extends BsMessageCQ {
     ...
     */
    public MessageCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
