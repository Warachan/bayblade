...
',
	...
	INTERESTED_INDUSTRY VARCHAR(50) COMMENT '希望業界 : 学生が希望している業界。',
...
(
	MESSAGE_ID INT(100) NOT NULL AUTO_INCREMENT COMMENT 'メッセージID',
	SENDER_ID INT(100) NOT NULL COMMENT '送信者ID : メッセー送信する会員のID
',
	RECEIVER_ID INT(100) NOT NULL COMMENT '受信者ID : 受信する会員のID
',
	MESSAGE_TIME VARCHAR(100) NOT NULL COMMENT '送信受信時間',
	MESSAGE VARCHAR(255) NOT NULL COMMENT 'message : メッセージ',
	INS_DATETIME DATETIME NOT NULL COMMENT 'insert日時',
	UPD_DATETIME DATETIME NOT NULL COMMENT 'UPD_DATETIME',
	INS_TRACE VARCHAR(256) NOT NULL COMMENT 'Insertトレース',
	UPD_TRACE VARCHAR(256) NOT NULL COMMENT 'UPD トレース',
